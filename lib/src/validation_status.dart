...
/// object. It aggregates the status of individual validation units in order to
/// represent the overall status.
/// {@endtemplate}
final class ValidationStatus {
  ...
  /// validation pipeline.
  ///
  /// Each element is a [UnitValidationStatus] generated by a validation node.
  ...
  /// validatation pipeline. It is initiated with the `validationName`
  /// as [UnitValidationStatus.nodeName] and with
  /// [UnitValidationStatusCode.notDefined] as the
  /// [UnitValidationStatus.statusCode]. The initial description is the default
  /// one.
  ...
  /// process. It will be used to describe the general state of this validation
  /// process.
  ...
  ///   failures or warnings. Only the last `success` message is maintained in
  ///   the overall state.
  ///
